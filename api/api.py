...
def analyzeWrapper(req, trx_id = 0):
	...
	try:
		resp_obj = FamaleFaceRecgnition.analyze(instances, actions = actions)
...
def verifyWrapper(req, trx_id = 0):
	...
	try:
		resp_obj = FamaleFaceRecgnition.verify(instances
...
def representWrapper(req, trx_id = 0):
	...
	try:
		...
		embedding = FamaleFaceRecgnition.represent(img
			, model_name = model_name
			, detector_backend = detector_backend
		)
