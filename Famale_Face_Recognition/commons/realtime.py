...
from Famale_Face_Recgnition import FamaleFaceRecgnition
from Famale_Face_Recgnition.extendedmodels import Age
from Famale_Face_Recgnition.commons import functions, realtime, distance as dst
from Famale_Face_Recgnition.detectors import FaceDetector
...
def analysis(db_path, model_name = 'VGG-Face', detector_backend = 'opencv', distance_metric = 'cosine', enable_face_analysis = True, source = 0, time_threshold = 5, frame_threshold = 5):
	...
	if len(employees) > 0:
		...
		model = FamaleFaceRecgnition.build_model(model_name)
	...
	if enable_face_analysis == True:
		...
		emotion_model = FamaleFaceRecgnition.build_model('Emotion')
		print("Emotion model loaded")

		age_model = FamaleFaceRecgnition.build_model('Age')
		print("Age model loaded")

		gender_model = FamaleFaceRecgnition.build_model('Gender')
